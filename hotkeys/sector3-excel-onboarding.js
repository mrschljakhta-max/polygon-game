...
function removeOverlay(){
 ...
 overlay=null;mon.classList.remove('vidlik-excel-card-open','vidlik-excel-launching','vidlik-excel-slides-open');
}
function ensureOverlay(){
 if(overlay?.isConnected)return overlay;
 overlay=document.createElement('section');overlay.className='vidlik-excel-onboarding vidlik-excel-slides';overlay.setAttribute('aria-label','Знайомство з Microsoft Excel');mon.appendChild(overlay);requestAnimationFrame(()=>overlay?.classList.add('is-visible'));return overlay;
}
