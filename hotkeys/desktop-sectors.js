...
async function leaveLevel(){stop();paused=false;phase='leaving';pressed.clear();locked=false;changingFullscreen=true;await keyboard.release(true);changingFullscreen=false;location.replace(`module-briefing.html?sector=${sector}`)}
