...
const manifests=Object.freeze({
 ...
 common:Object.freeze(['sector3-story-router.js?v=20260911-2','sector3-pause.js?v=20260910-1','sector3-input.js?v=20260911-1','sector3-ui.js?v=20260911-1']),
...
function fail(err){
 ...
 const h=document.getElementById('help');if(h)h.innerHTML='<span>ПОМИЛКА ЗАВАНТАЖЕННЯ СЦЕНИ</span><span><kbd>ESC</kbd> назад</span>';
